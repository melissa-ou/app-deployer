...
def parse_args(argv):
    ...
    parser.add_argument('app_name', metavar='app', type=str, nargs='?', help='app to rollback')
    parser.add_argument('host', metavar='host', type=str, nargs='?', help='host to rollback on')
...
def main(argv=None):
    ...
    logger = setup_logging('app_deployer')  # get instance of logger
